 ...
 * Date: 2026-01-06
 * IMPORTANT: AlarmMode import commented out as alarm_control_panel.ts is not yet imported.
 */
...
export const VACUUM_COMMANDS = ['start_pause', 'stop', 'clean_spot', 'locate', 'return_home'] as const;
