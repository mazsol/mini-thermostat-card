 ...
 * Source: https://github.com/home-assistant/frontend/blob/dev/src/data/water_heater.ts
 * Date: 2026-01-01
 */
import { mdiFinance, mdiFireCircle, mdiHeatWave, mdiLeaf, mdiLightningBolt, mdiPower, mdiRocketLaunch } from '@mdi/js';
...
export const compareWaterHeaterOperationMode = (mode1: OperationMode, mode2: OperationMode) =>
  waterHeaterOperationModeOrdering[mode1] - waterHeaterOperationModeOrdering[mode2];
...
export const computeOperationModeIcon = (mode: OperationMode) => WATER_HEATER_OPERATION_MODE_ICONS[mode];
